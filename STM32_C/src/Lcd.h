...
//#define TOGGLE_FULL_SCREEN // define-olt esetben nem csak a bábuk, hanem a teljes tartalom villog
typedef enum {KOR,KOR_KIRALY,NEGYZET,NEGYZET_KIRALY,URES, KIINDULASI_PONT} FigureType;

// A két oldalsávban megjelenõ adatok helyzete. A sorokat 0-tól kezdve felülrõl számozzuk.
