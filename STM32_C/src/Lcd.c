...
char Pattern[6][8]= // Bábuk mintázata
{
		...
		{0xFF,0x81,0x99,0xA5,0xA5,0x99,0x81,0xFF}, // kör király
...
void DrawTable(uint8_t PatternOn, uint8_t Scroll)
{
						...
						// A bábuk helyzetét a game.c-ben található Table tömb tartalmazza.
	{
		...
		{
			char tmp[5]; // Kiírjuk a játék állását a képernyõ két oldalára
			tmp[4] = 0;
...
#define ASCII_START 28 // Csak a 32-ik bejegyzéstõl valósítjuk meg az ASCII táblát, de a tábla elején 4 egyéni karakter  is van.
